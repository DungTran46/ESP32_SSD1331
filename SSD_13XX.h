...
class SSD_13XX : public Print {
 ...
 public:
		...
		SSD_13XX(const uint8_t cspin,const uint8_t dcpin,const uint8_t rstpin=255,const uint8_t mosi=11,const uint8_t sclk=13);
	#else
		SSD_13XX(const uint8_t cspin,const uint8_t dcpin,const uint8_t rstpin=255, const uint8_t mosi=13, const uint8_t sclk=14, const uint8_t spi_bus=2);
	#endif
